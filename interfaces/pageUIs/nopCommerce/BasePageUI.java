...
public class BasePageUI {
	public static final String MY_ACCOUNT_FOOTER = "//div[@class='footer']//a[text()='My account']";
	...
	public static final String DYNAMIC_FAGE_FOOTER = "//div[@class='footer']//a[text()='%s']";
