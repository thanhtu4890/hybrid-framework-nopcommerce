...
public class AdminBasePageUI {
	public static final String MENU_LINK_BY_NAME = "//ul[@role='menu']/li/a/p[contains(text(),'%s')]/parent::a";
	...
	public static final String NO_PRODUCT_IMAGE_MESSAGE_BY_TABLE_NAME = "//table[@id='%s-grid']//td[contains(string(),'%s')]";
}
