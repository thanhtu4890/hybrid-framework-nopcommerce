...
public class AdminBasePage {
	...
	public static AdminBasePage getBasePage() {
	...
	public boolean isMessageDisplayInEmptyTable(WebDriver driver, String tableName, String noDataMessage) {
		
		waitForElementVisible(driver, AdminBasePageUI.NO_PRODUCT_IMAGE_MESSAGE_BY_TABLE_NAME, tableName, noDataMessage);
		return isElementDisplay(driver, AdminBasePageUI.NO_PRODUCT_IMAGE_MESSAGE_BY_TABLE_NAME, tableName, noDataMessage);
	}
